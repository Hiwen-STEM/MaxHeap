...
def createBTO():
    ...
    #implementation...
    tree = np.memmap("0", dtype='float32', mode='w+', shape=(1000,1))
...
def MResize(BT):
    ...
    if(cols == 1000):
        ...
        tree = np.memmap(str(length), dtype='float32', mode='w+', shape=(1000,1))
